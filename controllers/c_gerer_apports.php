...
// gestion des erreurs
$hasErrors = false;
if ($_SESSION['profil'] == 1 OR $_SESSION['profil'] == 3) {
        ...
        case 'ajouterApport' : {
                ...
                switch ($option) {
                    ...
                    case 'validerApport' : {
                            ...
                            if (!empty($_POST["txtDateApport"]) and ! empty($_POST["cbxProduits"]) and ! empty($_POST["cbxSilos"]) and ! empty($_POST["cbxFournisseurs"])and ! empty($_POST["nbQteApport"]) and ! empty($_POST["nbQualite"]) and ! empty($_POST["txtPrixAchatEff"])
                            ) {
